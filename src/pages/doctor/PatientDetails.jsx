...
const PatientDetails = () => {
    ...
    const fetchPatientData = async () => {
        try {
            // Find patient from all patients (or direct endpoint if available)
            ...
            <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
                <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="btn btn-primary px-6 py-2.5 shadow-lg"
                    >
                ...
                <div className="grid lg-grid-cols-3 gap-10">
                    ...
                    <div className="space-y-8">
                        <div className="card text-center p-8 bg-white border-none shadow-sm">
                            <div className="w-24 h-24 bg-primary-subtle rounded-3xl flex items-center justify-center mx-auto mb-6 text-primary border-4 border-white shadow-xl">
                        ...
                        <div className="card p-6 bg-white border-none shadow-sm space-y-6">
                            <h3 className="text-sm font-black text-gray-400 uppercase tracking-widest border-b border-gray-50 pb-4">Contact Details</h3>
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-sm font-bold text-gray-700">{patient.mobile}</p>
                                </div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div key={visit.id} className="card p-8 bg-white border-none shadow-sm hover:shadow-xl transition-all group border-l-4 border-transparent hover:border-primary">
                                        <div className="flex justify-between items-start mb-6">
                                            ...
                                            <div className="flex gap-2">
                                                <button className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400 hover:bg-primary-subtle hover:text-primary transition-all">
                                        ...
                                        <div className="grid md-grid-cols-2 gap-8 mt-6 pt-6 border-t border-gray-50">
                                            <div className="space-y-4">
                                                <div className="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-widest">
                                                    <Heart className="w-3 h-3" /> Prescription Summary
                                                </div>
                                                <div className="flex flex-wrap gap-2">
                                                    {visit.medicines?.length > 0 ? (
                                                        ...
                                                        <span className="text-xs text-gray-400 font-medium italic">No medicines prescribed</span>
                                                    )}
                                                </div>
                                            </div>
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {visit.tests?.length > 0 ? (
                                                        ...
                                                        <span className="text-xs text-gray-400 font-medium italic">No tests record</span>
                                                    )}
                                                </div>
                                            </div>
                                        </div>
